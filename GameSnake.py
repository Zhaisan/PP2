...
burgerImage = pygame.image.load("burger.jpg")
burger_x = random.randint(0, 570)
burger_y = random.randint(0, 570)

def GameOver():
    screen.blit(gameoverImage,(0, 0))
def burger(x, y):
    screen.blit(burgerImage, (x, y))
...
while running:
    ...
    snake.draw()
    burger(burger_x, burger_y)
    Score(score_x, score_y)                
    #collision of burger and snake
    interaction = Collision(snake.elements[0][0], snake.elements[0][1], burger_x, burger_y)
